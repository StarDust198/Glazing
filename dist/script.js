...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["default"])('.popup_calc_btn', '.popup_calc', '.popup_calc_close', false);
});
  ...
  forms.forEach(function (form) {
    form.addEventListener('submit', function (e) {
      ...
      fetch('./assets/server.php', {
        ...
        console.log(response); // showThanksModal(message.success);

        form.reset(); // statusMessage.remove();
      }).catch(function (error) {
