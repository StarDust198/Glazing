...
window.addEventListener('DOMContentLoaded', () => {
    ...
    modal('.popup_calc_button', '.popup_calc_profile', '.popup_calc_profile_close', false, false);
    modal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false, false);
